...
public class PtzUcc extends PtzMode {
    ...
    public PtzUcc(McuControl control, int protocol, char address, int baudRate) throws RuntimeException {
    ...
    @SuppressWarnings("unused")
    private void sendBuffers(ByteBuffer buffer, int length, int rxTimeout) {
